...
- [x] 1. DigestSelectionPolicy(domain)を実装(テスト込み)
...
- [x] 2. PostedGuidRepository(infrastructure)を実装(テスト込み)
...
- [x] 3. ClaudeSummarizer(infrastructure)を実装(テスト込み)
...
- [x] 4. DiscordWebhookClient(infrastructure)を実装(テスト込み)
...
- [x] 5. BuildDigestUseCase(application)を実装(テスト込み)
...
- [x] 6. DigestScheduler(presentation)+ Feature Toggle を実装(テスト込み)
...
- [x] 7. README に notify(デイリーダイジェスト)の設定手順を追記
  - File: README.md
